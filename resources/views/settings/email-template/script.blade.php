...
<script>
    ...
    function addTemplate(){
        ...
        html += '</div>';
        html += '<div class="form-group">';
        html += '<label for="subject'+template_row+'">Subject</label>';
        html += '<input type="text" class="form-control" id="subject'+template_row+'" name="template['+template_row+'][subject]" placeholder="Enter Subject here" required>';
        html += '</div>';
        html += '<div class="form-group">';
