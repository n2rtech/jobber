        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Manage Team</a></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <form class="row g-2" id="filterForm" action="{{ route('manage-team.index') }}">
                    <div class="col">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{ route('manage-team.index') }}" class="btn btn-orange ml-1">
                            <i class="fa fa-undo"></i>
                        </a>

                        <a href="{{ route('manage-team.create') }}" class="btn btn-dark ml-1">
                            Create
                        </a>
                ...
                <table id="dataTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                <a href="{{ route('manage-team.edit', $user) }}" class="btn btn-warning"> <i class="fas fa-pen"></i> </a>
                                <button type="button" onclick="confirmDelete({{$user->id}})" class="btn btn-danger"><i class="fas fa-trash"></i> </button>
                                <form id='delete-form{{$user->id}}' action='{{route('manage-team.destroy', $user)}}' method='POST'>
