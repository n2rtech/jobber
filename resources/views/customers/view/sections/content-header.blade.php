    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                ...
                <input type="checkbox" id="type" name="type" value="{{ $customer->id }}" @if($customer->type == 'customer') checked @endif data-bootstrap-switch onchange="confirmAccept(this.value)">
