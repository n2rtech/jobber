                ...
                <div class="table-responsive sm-customers">
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <th  style="border-top: none;" width="40%">Address 2</th>
                                <th class="text-right" style="border-top: none;">Mobile_1</th>
                            </tr>
                            <tr>
                                <td style="border-top: none;" width="40%">{{ $customer->address_2 }}</td>
                            ...
                            <tr>
                                <th style="border-top: none;" width="40%">City</th>
                                <th class="text-right" style="border-top: none;">Mobile 2</th>
                            </tr>
                            <tr>
                                <td style="border-top: none;" width="40%">{{ $customer->city ?? 'Not Found' }}</td>
