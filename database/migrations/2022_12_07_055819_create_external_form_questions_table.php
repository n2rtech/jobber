...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('external_form_questions', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('type',['checkbox', 'dropdown', 'radio', 'text', 'textarea'])->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('external_form_questions');
    }
};
