...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->date) {
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereDate('created_at', $request->date)->count();
        ...
        if ($request->filter == 'today') {
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereDate('created_at', Carbon::today())->count();
        ...
        if ($request->filter == 'yesterday') {
            ...
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereDate('created_at', $yesterday)->count();
        ...
        if ($request->filter == 'week') {
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereBetween('created_at', [Carbon::now()->startOfWeek(), Carbon::now()->endOfWeek()])->count();
        ...
        if ($request->filter == 'month') {
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereBetween('created_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->count();
        ...
        if ($request->filter == 'year') {
            $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->whereBetween('created_at', [Carbon::now()->startOfYear(), Carbon::now()->endOfYear()])->count();
        ...
        $total_scheduled_jobs    = Job::where('scheduled', 'yes ')->whereNot('status', 'completed')->count();
